...
app.use(session({
    name: 'connect-spid-saml-check-idp.sid',
    secret: "SAML CHECK IdP",
    resave: false,
...
var authenticator = config_sp.agidloginAuthentication? new Authenticator("validator") : null;
...
require('./api/saml')	        (app, checkAuth, database);
