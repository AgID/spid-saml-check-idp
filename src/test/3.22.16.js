...
class Test_3_22_16 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.16";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim exp MUST be present";
