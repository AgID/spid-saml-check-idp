...
class Test_3_22_11 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.11";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim acr MUST be present";
