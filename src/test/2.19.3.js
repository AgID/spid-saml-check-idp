...
class Test_2_19_3 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.19.3";
        this.description = "The RequiredAttributeAuthority element is well formed but none of the values of Location elements inside RequiredAttributeAuthority element are present in the SPID OIDC Registry at the entity listing endpoint. SPID Level 2. Binding: HTTP-POST";
        this.validation = "required";
    }

    async exec() {

        const xmlt = "template_2.19.3";
