...
class Test_3_22_22 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.22";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim act MUST be a valid JSON object";
