...
class Test_2_8_2 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.8.2";
        this.description = "The Issuer element does not have a value";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "Issuer", "");
