...
class Test_3_22_13 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.13";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim iat MUST be present";
