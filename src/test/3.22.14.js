...
class Test_3_22_14 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.14";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - the value of iat MUST be a valid unix time";
