...
class Test_3_22_18 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.18";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim nbf SHOULD be present";
    ...
    async exec() {
        ...
        for(let t in Extensions.GrantedAttributeAuthority[0]) {
            ...
            if(grantTokenInnerSignedTokenPayload.nbf==null || grantTokenInnerSignedTokenPayload.nbf=='') {
                ...
                throw("GrantToken JWS (Grant Token Inner Signed Token) claim nbf SHOULD be present");
            }   
        }
