...
class Test_2_6_1 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.6.1";
        this.description = "The AttributeConsumingServiceIndex attribute does not have a value";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AttributeConsumingServiceIndex", "");
