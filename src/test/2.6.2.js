...
class Test_2_6_2 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.6.2";
        this.description = "The value of AttributeConsumingServiceIndex attribute is < 0";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AttributeConsumingServiceIndex", "-2");
