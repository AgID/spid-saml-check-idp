...
class Test_3_22_2 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.2";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim kid MUST be present";
    ...
    async exec() {
        ...
        for(let t in Extensions.GrantedAttributeAuthority[0]) {
            ...
            if(jws.header.kid==null || jws.header.kid=='') {
                ...
                throw("GrantToken JWS (Grant Token Inner Signed Token) claim kid is not present");
            }
        }
