...
class Test_2_10_3 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.10.3";
        this.description = "The Comparison attribute does not have a value";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "Comparison", "");
