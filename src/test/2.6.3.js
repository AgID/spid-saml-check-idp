...
class Test_2_6_3 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.6.3";
        this.description = "The value of AttributeConsumingServiceIndex is not valid (as from SP Metadata)";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AttributeConsumingServiceIndex", "123456789");
