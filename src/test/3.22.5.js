...
class Test_3_22_5 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.5";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - the value of iss MUST be a valid URL";
