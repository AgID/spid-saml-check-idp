...
class Test_2_4_5 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.4.5";
        this.description = "AssertionConsumerServiceURL is present and is not a URL";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AssertionConsumerServiceURL", "imnoturl");
