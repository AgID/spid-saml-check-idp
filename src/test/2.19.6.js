...
class Test_2_19_6 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.19.6";
        this.description = "The RequiredAttributeAuthority element is well formed and at least one value of Location elements inside RequiredAttributeAuthority is not empty and is present in the SPID OIDC Registry at the entity listing endpoint. User select at least one AA. SPID Level 2. Binding: HTTP-POST";
        this.validation = "required";
    }

    async exec() {

        const xmlt = "template_aa_base";
