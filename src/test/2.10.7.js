...
class Test_2_10_7 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.10.7";
        this.description = "The value of AuthnContextClassRef element is not a valid SPID level";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AuthnContextClassRef", "https://www.spid.gov.it/SpidL0");
