...
class Test_2_4_4 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.4.4";
        this.description = "AssertionConsumerService(Index and URL) are both not present";
        this.validation = "required";
    }

    async exec() {

        const xmlt = "template_2.4.4";
