...
class Test_3_22_7 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.7";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim aud MUST be present";
