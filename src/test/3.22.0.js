...
class Test_3_22_0 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.0";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim alg MUST be present";
