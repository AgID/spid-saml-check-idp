...
class Test_2_10_4 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.10.4";
        this.description = "The value of Comparison attribute is different from “minimum” (WARN)";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "Comparison", "exact");
