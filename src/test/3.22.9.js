...
class Test_3_22_9 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.9";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - claim sid MUST be present";
