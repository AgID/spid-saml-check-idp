...
class Test_3_19_2 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.19.2";
        this.description = "GrantToken - Attribute Destination MUST have a value";
    ...
    async exec() {
        ...
        for(let t in Extensions.GrantedAttributeAuthority[0]) {
            ...
            if(grantToken.Destination=='') {
                this.notes = grantToken;
                throw("Attribute Destination of GrantToken does not have a value");
            }
        }
