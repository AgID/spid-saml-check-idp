...
class Test_2_19_2 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.19.2";
        this.description = "The value of all Location elements inside RequiredAttributeAuthority element are empty. SPID Level 2. Binding: HTTP-POST";
        this.validation = "required";
    }

    async exec() {

        const xmlt = "template_2.19.2";
