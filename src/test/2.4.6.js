...
class Test_2_4_6 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.4.6";
        this.description = "AssertionConsumerServiceURL is present and is not a valid URL (as from SP Metadata)";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AssertionConsumerServiceURL",  config_server.host + "/samlacsisnotvalid");
