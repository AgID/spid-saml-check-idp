...
class Test_2_4_2 extends TestAuthRequest {
    
    constructor(metadata, authrequest={}) {
        super(metadata, authrequest);
        this.num = "2.4.2";
        this.description = "AssertionConsumerServiceIndex is present and is not a valid index";
    ...
    async exec() {
        ...
        Utility.defaultParam(defaults, "AssertionConsumerServiceIndex", "123456789");
