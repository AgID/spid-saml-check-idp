...
class Test_3_22_26 extends TestAuthResponse {

    constructor(metadata, authrequest, authresponse) {
        super(metadata, authrequest, authresponse);
        this.num = "3.22.26";
        this.description = "GrantToken JWS (Grant Token Inner Signed Token) - The payload MUST contain all the user attributes declared into the parameter aa-required-attributes into the OpenAPI document of the AA";
